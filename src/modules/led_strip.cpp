...
class LedStrip{
    public:
        ...
        uint32_t RED = this->strip.gamma32(strip.Color(255, 0, 0));
        uint32_t GREEN = this->strip.gamma32(strip.Color(0, 255, 0));
        uint32_t BLUE = this->strip.gamma32(strip.Color(0, 0, 255));
        uint32_t FUKSIA = this->strip.gamma32(strip.Color(255, 0, 255));
        uint32_t WHITE = this->strip.gamma32(strip.Color(255, 255, 255));
        uint32_t YELLOW = this->strip.gamma32(strip.Color(255, 255, 0));
